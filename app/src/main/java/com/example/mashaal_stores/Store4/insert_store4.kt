...
import com.example.mashaal_stores.databinding.FragmentInsertStore3Binding
import com.example.mashaal_stores.databinding.FragmentInsertStore4Binding
import kotlinx.coroutines.launch
import java.time.LocalDate
import java.time.format.DateTimeFormatter

class insert_store4 : Fragment() {

    private val viewmodel : Store1_viewmodel by activityViewModels()
    val c=0
    val positiveButtonClick = { dialog: DialogInterface, which: Int -> }
    private lateinit var binding : FragmentInsertStore4Binding
    ...
    override fun onCreateView(
       ...
       binding = FragmentInsertStore4Binding.inflate(inflater,container,false)
                    ...
                    if(num < sadr){
                        ...
                        try{
                            lifecycleScope.launch {
                                viewmodel.insert_store4(item1(0, name, type, curdate, num, sadr, num - sadr))
                                nameInsert.setText("")
                                numInsert.setText("")
                                sadrInsert.setText("")
                            }
