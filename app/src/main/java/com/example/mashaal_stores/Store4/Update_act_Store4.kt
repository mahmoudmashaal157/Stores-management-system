...
import com.example.mashaal_stores.databinding.ActivityUpdateActStore4Binding
...
class Update_act_Store4 : AppCompatActivity() {
    var sadr = 0.0
    var ward = 0.0
    ...
    private lateinit var binding : ActivityUpdateActStore4Binding
    @RequiresApi(Build.VERSION_CODES.O)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityUpdateActStore4Binding.inflate(layoutInflater)
        setspinneradapter()
        ...
        lifecycleScope.launch {
            ...
            Log.v("name1", ss)
            val db = Store4_Database.getdatabase(applicationContext)
            try{
                ...
                updateButton.setOnClickListener {
                    ...
                    if (wardUpdate.text.isNotEmpty() && sadrUpdate1.text.isEmpty()) {
                        ...
                        if (sadrUpdate1.text.toString().toDouble() > num) {
                            val builder = AlertDialog.Builder(this@Update_act_Store4)
