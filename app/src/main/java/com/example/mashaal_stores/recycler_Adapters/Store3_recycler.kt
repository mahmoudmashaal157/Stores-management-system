...
class Store3_recycler (private val context: Store3, val dataset :MutableList<item1>
):
    RecyclerView.Adapter<Store3_recycler.Viewholder>(), Filterable
{
    ...
    inner  class Viewholder(private val view : View): RecyclerView.ViewHolder(view){
        ...
        init {
            ...
            view.setOnClickListener {
                ...
                var intent = Intent(view.context, update_act_store3::class.java)
