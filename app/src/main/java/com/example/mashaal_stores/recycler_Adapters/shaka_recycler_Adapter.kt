...
class shaka_recycler_Adapter (private val context: Shaka_Store ,val dataset :MutableList<item1>

):
RecyclerView.Adapter<shaka_recycler_Adapter.Viewholder>(),Filterable
{
   ...
   inner  class Viewholder(private val view :View):RecyclerView.ViewHolder(view){
         ...
         init {
             ...
             view.setOnClickListener {
                ...
                // onclickListner.onclick(adapterPosition)
                 var intent =Intent(view.context,update_act::class.java)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Viewholder {
        val adapterlayout =LayoutInflater.from(parent.context).inflate(R.layout.recycler_of_items,parent,false)
