...
import com.example.mashaal_stores.Store5.Store5
import com.example.mashaal_stores.Store5.Update_act_Store5

class Store5_Adapter (private val context: Store5, val dataset :MutableList<item1>
):
    RecyclerView.Adapter<Store5_Adapter.Viewholder>(), Filterable
{
    ...
    inner  class Viewholder(private val view : View): RecyclerView.ViewHolder(view){
        ...
        init {
            ...
            view.setOnClickListener {
                ...
                var intent = Intent(view.context, Update_act_Store5::class.java)
