...
import com.example.mashaal_stores.databinding.ActivityUpdateActStore3Binding
...
class update_act_store3 : AppCompatActivity() {
    private val viewmodels: Store1_viewmodel by viewModels()

    lateinit var binding: ActivityUpdateActStore3Binding
    var sadr = 0.0
    var ward = 0.0
    var update_flag = 1
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityUpdateActStore3Binding.inflate(layoutInflater)
        setspinneradapter()
        ...
        lifecycleScope.launch {
            ...
            Log.v("name1", ss)
            val db = Store3_Database.getdatabase(applicationContext)
            try{
                ...
                updateButton.setOnClickListener {
                    ...
                    if (wardUpdate.text.isNotEmpty() && sadrUpdate1.text.isEmpty()) {
                        ...
                        if (sadrUpdate1.text.toString().toDouble() > num) {
                            val builder = AlertDialog.Builder(this@update_act_store3)
