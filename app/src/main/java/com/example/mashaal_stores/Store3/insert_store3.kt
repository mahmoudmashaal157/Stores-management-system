...
class insert_store3 : Fragment() {
    private val viewmodel : Store1_viewmodel by activityViewModels()
    val c=0
    val positiveButtonClick = { dialog: DialogInterface, which: Int -> }
    private lateinit var binding : FragmentInsertStore3Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentInsertStore3Binding.inflate(inflater,container,false)
                    ...
                    if(num < sadr){
                        ...
                        try{
                            lifecycleScope.launch {
                                viewmodel.insert_store3(item1(0, name, type, curdate, num, sadr, num - sadr))
                                nameInsert.setText("")
                                numInsert.setText("")
                                sadrInsert.setText("")
                            }
