...
import com.example.mashaal_stores.databinding.FragmentInsertItemBinding
import kotlinx.coroutines.launch
import java.time.LocalDate
import java.time.format.DateTimeFormatter


class insert_item : Fragment() {
                       ...
                       builder.setPositiveButton("OK", DialogInterface.OnClickListener(function = positiveButtonClick))
                        ...
                        try{
                            lifecycleScope.launch {
                                viewmodel.insert(item1(0, name, type, curdate, num, sadr, num - sadr))
                                nameInsert.setText("")
                                numInsert.setText("")
                                sadrInsert.setText("")
                        }
